...
{
    public class Latin7FinnishModel : FinnishModel
    {
        ...
        private static byte[] LATIN7_CHAR_TO_ORDER_MAP = {
        ...
        public Latin7FinnishModel() : base(LATIN7_CHAR_TO_ORDER_MAP, "ISO-8859-13")
        {
        }
    }
}
