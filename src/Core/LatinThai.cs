...
{
    public class LatinThai : ThaiModel
    {
        ...
        private readonly static byte[] LATIN_THAI_CHAR_TO_ORDER_MAP[] =
        {
        ...
        public LatinThai() : base(LATIN_THAI_CHAR_TO_ORDER_MAP, "ISO-8859-11")
        {
        }
    }
}
