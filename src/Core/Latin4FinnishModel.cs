...
{
    public class Latin4FinnishModel : FinnishModel
    {
        ...
        private static byte[] LATIN4_CHAR_TO_ORDER_MAP = {
        ...
        public Latin4FinnishModel() : base(LATIN4_CHAR_TO_ORDER_MAP, "ISO-8859-4")
        {
        }
    }
}
