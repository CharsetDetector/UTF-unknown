...
{
    public class Latin9FinnishModel : FinnishModel
    {
        ...
        private static byte[] LATIN9_CHAR_TO_ORDER_MAP = {
        ...
        public Latin9FinnishModel() : base(LATIN9_CHAR_TO_ORDER_MAP, "ISO-8859-15")
        {
        }
    }
}
