...
{
    public class Latin1SwedishModel : SwedishModel
    {
        ...
        private static byte[] LATIN1_CHAR_TO_ORDER_MAP = {
        ...
        public Latin1SwedishModel() : base(LATIN1_CHAR_TO_ORDER_MAP, "ISO-8859-1")
        {
        }
    }
}
